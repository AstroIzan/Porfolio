...
var unityCounter = document.getElementById("unityCounter");
// Slides
var htmlOptionsHtml = document.getElementsByName("htmlOptionsHtml");
var htmlOptionsJs = document.getElementsByName("htmlOptionsJs");
// Functions
// Page loader
/**
 * Carga la página
...
function darkMode(number) {
    switch (number) {
        case 0:
            var colorModeButton = document.getElementById("colorModeButton0");
            break;
        case 1:
            var colorModeButton = document.getElementById("colorModeButton1");
            break;
    }
